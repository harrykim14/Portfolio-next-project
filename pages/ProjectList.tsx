    ...
    <Layout title="Project List">
      <div className="min-h-screen">
        ...
        <div className={discribeTextStyle}>
          ...
          <div className="flex flex-wrap lg:flex-row md:flex-col justify-around my-6">
        ...
        <div className={discribeTextStyle}>
          ...
          <p className="mx-8">
            <span className="font-bold">Usage</span> : React Hook, Mongo DB,
            Node.js server, Material-ui
            <br />
            <span className="font-bold">Describe</span> : Rebuild the first memo
            app with React and mongo DB(modeling with Mongoose). Some UI/UX
            changed and improved user convenience. Also tried TDD method of
            development.
            <br />
            <span className="font-bold">Duration</span> : 4 weeks
            <br />
        ...
        <div className={discribeTextStyle}>
          ...
          <p className="mx-8">
            <span className="font-bold">Usage</span> : React Hook, Node.js
            server, Google Firebase DB
            <br />
            <span className="font-bold">Describe</span> : A simple chat app with
            real-time database, Firebase. Front side was built by React Hook.
            <br />
        ...
        <div className={discribeTextStyle}>
          ...
          <p className="mx-8">
            <span className="font-bold">Usage</span> : Python, django, django
            REST framework, Javascript, React, NextJs, Tailwind CSS
            <br />
            <span className="font-bold">Describe</span> : Simple blog page with
            NextJS, To-do list(CRUD) is changed with user event through django
            REST api modeled by django REST framework.
            <br />
        ...
        <div className={discribeTextStyle}>
          ...
          <p className="mx-8">
            <span className="font-bold">Usage</span> : Javascript based Hexo
            framework
            <br />
            <span className="font-bold">Describe</span> : Individual blog for
            summary personal studies that is built by Hexo framework.
            <br />
            <span className="font-bold">Duration</span> : 1 days to build, Keep
            updated
            <br />
            <span className="font-bold">Participation</span> : 100% (personal
            project)
